...
var HttpClienteService = (function () {
    ...
    HttpClienteService.prototype.getClientes = function () {
        return this._http.
            get('http://aulafacearanderson.jelasticlw.com.br/aulafacear/rest/clientes').
    ...
    HttpClienteService.prototype.addCliente = function (cliente) {
        ...
        return this._http.
            post('http://aulafacearanderson.jelasticlw.com.br/aulafacear/rest/clientes', json, options).map(function (res) { return res.json(); });
    };
